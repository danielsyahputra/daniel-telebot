...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = 'Daniel Syahputra',
            BATCH_ACADEMY = 'QOPPA Night',
            GITHUB_REPO_LINK = 'https://github.com/danielsyahputra13/telebot-capstone-project'
        )
...
def send_plot(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        plot_info = list(zip(
            ...
            [
                df_plot[df_plot[col] == df_plot[col].max()].index.values[0] for col in columns
            ],
            [
                df_plot[df_plot[col] == df_plot[col].min()].index.values[0] for col in columns
            ]))
...
def echo_all(message):
    ...
    with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
        ...
        default = temp.substitute(EMOJI = emoji.emojize(':red_heart:'))
